...
class Utility {
    class func data(fromUInt16: UInt16) -> Data {
        return Data(bytes: [UInt8(fromUInt16 & 0x00ff), UInt8((fromUInt16 & 0xff00) >> 8)].reversed())
    }
    
    class func data(fromUInt32: UInt32) -> Data {
        return Data(bytes: [UInt8(fromUInt32 & 0x000000ff), UInt8((fromUInt32 & 0x0000ff00) >> 8), UInt8((fromUInt32 & 0x00ff0000) >> 16), UInt8((fromUInt32 & 0xff000000) >> 24)].reversed())
    }
